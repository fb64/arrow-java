...
/** Test cases for {@link AllocationManager} type resolution. */
public class TestAllocationManagerFfm {

  @AfterEach
  public void after() {
    // Avoid leaking this JVM-wide property into other tests sharing this Surefire fork.
  ...
  public void testAllocationManagerType() {
    System.setProperty(DefaultAllocationManagerOption.ALLOCATION_MANAGER_TYPE_PROPERTY_NAME, "FFM");
